...
public class RegistrationService {
    ...
    public ResponseEntity<?> handleRegistration(CreateUserDTO userDetails, HttpServletResponse response){
        ...
        auths.add(new Authorities(utils.generateUniqueId(), accountDetailsId, Role.USER));
        AccountDetails accountDetails = new AccountDetails(accountDetailsId, username, pe.encode(userDetails.getPassword()), auths);
        Teacher teacher = new Teacher(teacherId, userDetails.getFirstName(), userDetails.getLastName(), accountDetailsId);
